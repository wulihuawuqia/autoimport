...
public class UtilStr  {
    ...
    public static Calendar toCalendar(String sdate, String delimate) {
        ...
        StringTokenizer st = new StringTokenizer(sdate, delimate);
        try {
            int y = 0, m = 0, d = 0;
            if (st.hasMoreTokens()) {
    ...
    /**
     * 将任意字符串转为首字母大写其余字母小写的字符串
     * @param string
     * @return
     */
    public static String toUppercaseFirstChar(String string){
        return new StringBuilder().append(Character.toUpperCase(string.toLowerCase().charAt(0))).append(string.toLowerCase().substring(1)).toString();
    }
     ...
     **/
    public static boolean isHave(String substring, String[] source) {
